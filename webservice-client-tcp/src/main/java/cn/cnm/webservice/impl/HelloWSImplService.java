 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://impl.webservice.cnm.cn/", wsdlLocation = "file:/D:/spring-space/webservice-client-tcp/src/main/java/hello.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://impl.webservice.cnm.cn/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/spring-space/webservice-client-tcp/src/main/java/hello.wsdl");
    ...
    public HelloWS getHelloWSImplPort() {
        return super.getPort(new QName("http://impl.webservice.cnm.cn/", "HelloWSImplPort"), HelloWS.class);
    }
    ...
    public HelloWS getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.webservice.cnm.cn/", "HelloWSImplPort"), HelloWS.class, features);
    }
